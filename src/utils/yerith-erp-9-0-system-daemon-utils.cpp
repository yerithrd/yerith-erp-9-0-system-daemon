/*
 * yerith-erp-9-0-system-daemon-utils.cpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */

#include "yerith-erp-9-0-system-daemon-utils.hpp"


#include "src/yerith-erp-9-0-system-daemon-logger.hpp"
...
QString YerothERPAlertUtils::_logFileName("yerith-erp-9-0-system-daemon.log");
...
void YerothERPAlertUtils::YERITH_CREATE_FOLDER(const QString &aFullPathDir)
{
    QFileInfo aFullPathDirInfo(aFullPathDir);

    if (!aFullPathDirInfo.exists())
    {
        qDebug() << "[YerothERPAlertUtils] YERITH_CREATE_FOLDER"
...
//    qDebug() << "program_executable_args: " << program_executable_args;
    ...
    program_output_IN_OUT.append(A_YERITH_PROCESS.readAllStandardOutput().
                                 trimmed());
...
bool
YerothERPAlertUtils::
GZIP_YERITH_FILE(const QString &program_working_directory_full_path,
...
bool YerothERPAlertUtils::execQuery(const QString &strQuery,
                                    YERITH_ERP_SYSTEM_DAEMON_LOGGER *logger)
{
