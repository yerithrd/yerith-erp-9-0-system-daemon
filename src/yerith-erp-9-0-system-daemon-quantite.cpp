/*
 * yerith-erp-9-0-system-daemon-quantite.cpp
 *
...
#include "src/entities/yerith-erp-9-0-system-daemon-entity-alert-quantity-period-time.hpp"
...
YERITH_ERP_SYSTEM_DAEMON_ALERT_OVER_STOCK_QUANTITY::
...
void YERITH_ERP_SYSTEM_DAEMON_ALERT_OVER_STOCK_QUANTITY::doChecks()
{
...
void YERITH_ERP_SYSTEM_DAEMON_ALERT_OVER_STOCK_QUANTITY::checkAlertes(const
...
void
YERITH_ERP_SYSTEM_DAEMON_ALERT_OVER_STOCK_QUANTITY::process_courrier_alertes
(const QString &TRIGGER_CONDITION,
 const _StockRecord__FOR_ALERT_QUANTITY &aStockQuantiteAlerteData)
{
//      QDEBUG_STRING_OUTPUT_2("YERITH_ERP_SYSTEM_DAEMON_ALERT_OVER_STOCK_QUANTITY::process_courrier_alertes",
//                                                      TRIGGER_CONDITION);

    YERITH_ERP_SYSTEM_DAEMON_ALERT_ABSTRACT_ENTITY::process_courrier_alertes
