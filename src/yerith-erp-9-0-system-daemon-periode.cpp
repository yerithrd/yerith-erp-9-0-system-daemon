...
void YERITH_ERP_SYSTEM_DAEMON_ALERT_PERIOD_TIME::doChecks()
{
...
void
YERITH_ERP_SYSTEM_DAEMON_ALERT_PERIOD_TIME::process_courrier_alertes
(const QString &TRIGGER_CONDITION,
 const _StockRecord__FOR_ALERT_QUANTITY &aStockQuantiteAlerteData)
{
//      QDEBUG_STRING_OUTPUT_2("YERITH_ERP_SYSTEM_DAEMON_ALERT_PERIOD_TIME::process_courrier_alertes",
//                                                      TRIGGER_CONDITION);
