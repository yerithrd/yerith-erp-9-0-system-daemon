/*
 * yerith-erp-9-0-system-daemon-alert-abstract-entity.cpp
 *
 *      Author: PROF. DR.-ENG. DIPL.-INF. Xavier Noundou
 */


#include "yerith-erp-9-0-system-daemon-alert-abstract-entity.hpp"
...
void YERITH_ERP_SYSTEM_DAEMON_ALERT_ABSTRACT_ENTITY::
